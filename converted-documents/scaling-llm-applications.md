...
original_file: "./Scaling_LLM_Applications.pdf"
document_type: "research"
conversion_date: "2025-11-29"
topics: ["prompt-engineering", "llm", "rag", "chain-of-thought", "react"]
keywords: ["suggestion", "agent", "language", "page", "agents", "result", "learning", "node", "prompts", "tools"]
summary: "<!-- Page 1 -->
...
AIWavesInc. {chunshu,eleanor}@aiwaves.cn
...
(LLMs)pipelinesinvolvingbothpromptingtechniquesa"
related_documents: []
---
...
Whilelanguageagentshavedemonstratedimpressivecapabilitiesformanyrealworldtasks,afundamentallimitationofcurrentlanguageagentsresearchisthatthey
...
“languageloss”. Afterward,weback-propagatethelanguagelossfromthelasttothefirstnodealong
...
promptengineeringforthemselves. Ontheotherhand,Prasadetal.[2023]andGuoetal.[2024]
...
engineering,methodsforagentoptimizationcanalsobecategorizedintotwocategories: promptbasedandsearch-based. Forexample,Agent-pro[Zhangetal.,2024b]andAgentOptimizer[Zhang
...
12: ∇n lang ←G(∇n la + ng 1,I n ,O n ,P n ,T n ,L lang ) ▷∇n la + ng 1 =∅forthelastnode
13: Append∇n toτ
lang
14: endfor
15: WeightUpdate
16: foreachN ∈Ado
17: UpdateP n ,T n using∇n lang ▷Updatepromptsandtools
18: endfor
...
Initialized 2 Next node is selected by transition controller of node Forward Pass
2 2 2
...
e
e
1 Next agent is selected by routing controller of node z e
...
Optimized Prompt Optimizer r y
o
t
Pipeline Optimizer G L r a a n d g i u e a n g t e s a j e c
r
...
3.2 AgentSymbolicLearningProcedure
...
frameworkindetail.
ForwardPass Theforwardpassisalmostidenticaltostandardagentexecution. Themaindifference is that we store the input, prompts, tool usage, and the output to the trajectory, which is
...
and tools in each node and optimize the overall agent pipeline with the help of language gradients. Thisisaccomplishedvia“symbolicoptimizers”. Symbolicoptimizersarecarefullydesigned
...
ToolOptimizer: TheToolOptimizerisapipelineofpromptsthatfirstinstructstheLLMtodecidethe
...
## We can see that the proposed agent symbolic learning framework consistently improves over
...
inspirationfromstandardconnectionistlearningproceduretodosymboliclearning. Ituseslanguagebasedloss,gradients,andoptimizerstooptimizeprompts,tools,andtheagentpipelinewithrespect
...
OmarKhattab,ArnavSinghvi,ParidhiMaheshwari,ZhiyuanZhang,KeshavSanthanam,SriVardhamanan, Saiful Haq, Ashutosh Sharma, Thomas T. Joshi, Hanna Moazam, Heather Miller,
...
## URLhttps://openreview.net/forum?id=Yacmpz84TH.
...
Bashlykov,SoumyaBatra,PrajjwalBhargava,ShrutiBhosale,DanBikel,LukasBlecher,CristianCantonFerrer, MoyaChen, GuillemCucurull, DavidEsiobu, JudeFernandes, JeremyFu,
...
ChristopherD.Manning. HotpotQA:Adatasetfordiverse,explainablemulti-hopquestionanswering. InEllenRiloff,DavidChiang,JuliaHockenmaier,andJun’ichiTsujii,editors,Proceedingsof
...
### Ensurethattheoutputiswrappedwith<score></score>and<suggestion></suggestion>respectively.


### Theoutputshouldbeasconsistentaspossiblewiththeexpectedresultwhilebeingcorrect.Forexample,
...
## Thestandardforascoreof10isthatthemodel’soutputisexactlythesameastheexpectedresultina
...
correctresult.Youneedtoevaluateitandsuggestmodificationstothemodel’soutput.Pleaseuse‘<suggestion></suggestion>‘toencloseyourfeedback.
...
### Ensurethat‘<suggestion></suggestion>‘existsandappearsonce.


## Ifthemodel’soutputissatisfactory,youcanoutput<suggestion>Theoutputissatisfactory,noadditional

requirements</suggestion>.

### Theoutputshouldbeasclosetotheexpectedresultaspossiblewhileensuringcorrectness.Forexample,
...
PromptTemplateforGradientBack-propagation
...
## Ensurethattheresultsarewrappedwith<suggestion></suggestion>and<suggestion></suggestion>,and

eachtagappearsonlyonce.

### Ifyouarethefirstnode,youcanstatewithin<suggestion></suggestion>“Thisisthefirstnode.”


## Pleasenotethatduringyouranalysis,rememberthatthisprompttemplatewillbeappliedtomultiple

differentdatasets,soyoursuggestionsshouldbegeneralandnotsolelyfocusedontheexamplesprovided
here.

### Pleaseanalyzestepbystep.
...
### Updatethenodedescriptionfield.Thisfielddescribesthefunctionofthenodeandisalsoanimportant

indicatortomeasuretheperformanceofanode.

#### Updatetheschedulingmethodoftherole.Notethatifthereisonlyonerole,nooptimizationisneeded.


### Addanewrole,andyouneedtoclearlydescribethefunctionofthisrole.


### Deletearole,andyouneedtoclearlydescribethereasonfordeletingthisrole.


### Updatearole,andyouneedtoindicatehowtoupdatethedescriptionofthisrole.
...
optimizationsuggestionsforthecurrentnode.Pleaseuse<suggestion></suggestion>toenclosetherequirementsforthepreviousnode.
...
## Whenactuallyusingtheprompttemplate,thePythonformat()methodisemployedtofillvariablesinto
...
## Ensurethatyournewprompttemplatecanbedirectlyconvertedtoadictionaryusingthejson.loads()

method.Therefore,youneedtobecarefultousedoublequotesandescapecharactersproperly.

### Ensurethat<analyse></analyse>and<new_prompt></new_prompt>eachappearonlyonce.
...
## Ifyouthinkthecurrentconfigurationisalreadyexcellentanddoesnotneedmodification,youcandirectly

outputanemptylist.

## Theformatof<result>[optimizationmethod]</result>needstostrictlyfollowthegivenformat,otherwise,
...
| Task Tools LLM Pipeline Agent Frozen Prompt Node Updated | Trajectory Nodet ⊕ Agentt ⊕ Actiont ⊕ Environmentt State State2 Statet-1 Statet 1 |
|---|---|
| Back Propagation of Language Gradients Optimized Prompt Optimizer r y o t Pipeline Optimizer G L r a a n d g i u e a n g t e s a j e c r T Tool Optimizer |  |


**Table (Page 7):**

| HotPotQA GPT-3.5 GPT-4 | MATH GPT-3.5 GPT-4 |
|---|---|
| 24/38.8 33/44.3 27/37.5 39/49.8 29/39.8 38/50.3 35/43.9 40/50.5 | 23.2 53.1 23.8 56.0 22.5 57.2 17.3 48.4 |
| 35/44.8 41/54.0 | 38.8 60.7 |
